                                ...
                                <div class="card-body general-info">
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" placeholder="Name" class="form-control"  id="fullnameInput"  value="{{ old('name') }}">
                                            </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="email" placeholder="Email" class="form-control" id="mailInput" value="{{ old('email') }}" >
                                            </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="phone" name="contact_number" placeholder="Contact Number" class="form-control"  id="contact_number"  value="{{ old('contact_number') }}">
                                            </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-user"></i></div>
                                                <select name="roles[]" class="form-control" multiple="multiple" id="roleInput">
